...
def elevator_floor(floor):
    if floor == 'M':
        print('You are on the lobby floor')
    elif floor == 'B':
        print('You are on the basement floor')
    elif floor == 'R':
        print('You are on the rooftop floor')
    elif floor == 'G':
        print('You are on the gym floor')
    elif floor == 'R':
        print('You are on the restaurant floor')
    elif floor == 'W':
        print('You are on the workspace floor')
    elif floor == 'L':
        print('You are on the living quarters floor')
    else:
        print('The floor you entered does not exist. Please enter another floor number and try again.')
